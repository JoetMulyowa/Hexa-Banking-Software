...
DROP INDEX IF EXISTS `IDX_yo_payment_transaction_loan_id` ON `m_yo_payment_transaction`;
DROP INDEX IF EXISTS `IDX_yo_payment_transaction_middleware_reference` ON `m_yo_payment_transaction`;
DROP INDEX IF EXISTS `IDX_yo_payment_transaction_vendor_tran_id` ON `m_yo_payment_transaction`;
