...
/**
 * Interface for Yo Payment Mobile Money Integration
 */
public interface YoPaymentMomoIntegrationWritePlatformService extends MomoPaymentIntegrationWritePlatformService {

    /**
     * Process a payout (withdrawal) through Yo Payment's Momo API
     *
