...
/**
 * Entity class for storing Yo Payment repayment transaction data
 */
@Entity
@Table(name = "m_yo_payment_repayment_transaction")
@Data
...
public class YoPaymentRepaymentTransaction extends AbstractAuditableCustom {
